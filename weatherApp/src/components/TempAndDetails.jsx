...
const TempAndDetails = ({weather:{
    ...
    return (
        <div>
            <div className="flex items-center justify-center py-6 text text-xl text-cyan-300">
                <p>{details}</p>
            </div>
                ...
                <div className="flex flex-col space-y-3 items-start">
...

                    {
                        verticalDetails.map(({ id, Icon, title, value }) => (
                            ...
                            <div key={id} className="flex font-light text text-sm items-center justify-center">
